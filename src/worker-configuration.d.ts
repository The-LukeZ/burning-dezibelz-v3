/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts --env-file=.env.production` (hash: 4f00ef0331efc56497f8e28eace59ec1)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "HOST" | "PORT" | "PUBLIC_SUPABASE_URL" | "PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "SUPABASE_JWT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "CF_ACCOUNT_ID" | "CF_ACCOUNT_TOKEN" | "CF_ACCOUNT_HASH" | "PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET" | "SENTRY_AUTH_TOKEN" | "SENTRY_LOG_LEVEL" | "RESEND_API_KEY">> {}
}
