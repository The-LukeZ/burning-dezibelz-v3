/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts --env-file=.env.production` (hash: 6535a822d4a485b9cfa7d56b8354c588)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "HOST" | "PORT" | "NODE_ENV" | "PUBLIC_SUPABASE_URL" | "PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "CF_ACCOUNT_ID" | "CF_ACCOUNT_TOKEN" | "CF_ACCOUNT_HASH" | "PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET" | "SENTRY_AUTH_TOKEN" | "SENTRY_LOG_LEVEL" | "RESEND_API_KEY">> {}
}
