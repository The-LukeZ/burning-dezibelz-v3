/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts --env-file=.env.production` (hash: 789883f0ec88f2ff488981a44d21fe24)
